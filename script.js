...
// moves -- what a long-winded approach!! this needs shortening....
    const move = pokemon.moves[1].move.name[0].toUpperCase() + pokemon.moves[1].move.name.slice(1);
...
// name
	...
	const pokeInnerHTML = `
        ...
        <div class="info">
            ...
            <small class="type">MOVES MOVES MOVES: <span>${move}</span></br></small>
